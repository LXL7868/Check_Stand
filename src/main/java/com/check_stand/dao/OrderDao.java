...
import com.check_stand.common.OrderStatus;
import com.check_stand.entity.Order;
import com.check_stand.entity.OrderItem;
...
public class OrderDao extends BaseDao {
    ...
    public boolean insertOrder(Order order) {
        ...
        String insertOrderSql = "insert into `orders`(id, account_id, create_time, finish_time, actual_amount, total_money, order_status, account_name) values (?,?,?,?,?,?,?,?)";
